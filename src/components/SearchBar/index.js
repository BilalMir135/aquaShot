...
function SearchBar() {
  ...
  return (
    <Paper elevation={3} component="form" className={tablet ? classes.root : classes.rootMobile}>
      <InputBase
      ...
      />
      <IconButton type="submit" className={!validAccountAddress ? classes.iconButtonDisabled : classes.iconButton} aria-label="search"
